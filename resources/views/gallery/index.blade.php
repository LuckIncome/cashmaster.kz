                  ...
                  <table class="table table-bordered mb-0">
                     ...
                     @foreach ($gallery as $item)
                        <tr>
                           ...
                           <td>
                            <a href="{{ route('gallery.show', $item->id) }}"><button type="submit" class="btn btn-success btn-sm waves-effect">Показать</button></a>
                            <a href="{{ route('gallery.edit', $item->id) }}"><button type="submit" class="btn btn-warning btn-sm waves-effect">Редактировать</button></a>
