         ...
         <div class="col-sm-12">
            <div class="page-title-box">
               <div class="row align-items-center">
                  <div class="col-md-8">
                     <h4 class="page-title mb-0">Роли и права доступа</h4>
                     <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin') }}">Cashmaster</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Роли и права доступа</li>
                     </ol>
                  </div>
               </div>
            </div>
            ...
            <div class="card">
               <div class="card-body">
                    ...
                    <p class="text-muted m-b-15">
                        <a href="{{ route('roles.create') }}"><button class="btn btn-primary btn-sm waves-effect">Создать пользователя</button></a>
                    </p>
