    ...
    <div class="container-fluid">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('currency.index') }}">Валюта</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Данные валюты "{{ $currencies->name }}"</h4>
                        <p class="text-muted m-b-30 font-14">Валюта</p>
                        ...
                        <div class="form-group row">
                            <label for="coefficient" class="col-sm-2 col-form-label">Курс</label>
