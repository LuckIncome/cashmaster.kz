                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="title" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ old('title', $products->title) }}" required>
                            @if ($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input id="metadesc" class="form-control{{ $errors->has('metadesc') ? ' is-invalid' : '' }}" name="metadesc" value="{{ old('metadesc', $products->metadesc) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input id="keywords" class="form-control{{ $errors->has('keywords') ? ' is-invalid' : '' }}" name="keywords" value="{{ old('keywords', $products->keywords) }}" required>
                        ...
                        <button type="submit" class="btn btn-primary waves-effect">Обновить</button>
                            <a class="btn btn-primary waves-effect" href="{{ route('products.index') }}">Назад</a>
                            <a href="/admin/products/{{$products->id}}/parameters" class="btn btn-primary">Перейти к характеристикам</a>
                        </form>
...
{{--                        </form>--}}
                        ...
                        <div class="clearpicture">
                            <form class="clearpicture" method="POST" action="{{ route('clearpicture') }}"  enctype="multipart/form-data">
                            @csrf
                                <input type="hidden" name="imagedelete" value="{{ $id }}">
                                <input type="hidden" name="image2delete" value="{{ $products->image1 }}">
                                <div><button type="submit" class="btn btn-primary waves-effect">Очистить картинку 1</button></div>
                            </form>
                        </div>
                        
                        <div class="clearpicture2">
                            <form method="POST" action="{{ route('clearpicture2') }}"  enctype="multipart/form-data">
                            @csrf
                                <input type="hidden" name="imagedelete2" value="{{ $id }}">
                                <input type="hidden" name="image2delete" value="{{ $products->image2 }}">
                                <div><button type="submit" class="btn btn-primary waves-effect">Очистить картинку 2</button></div>
                            </form>
                        </div>
                        
                        <div class="clearpicture3">
                            <form method="POST" action="{{ route('clearpicture3') }}"  enctype="multipart/form-data">
                            @csrf
                                <input type="hidden" name="imagedelete3" value="{{ $id }}">
                                <input type="hidden" name="image2delete" value="{{ $products->image3 }}">
                                <div><button type="submit" class="btn btn-primary waves-effect">Очистить картинку 3</button></div>
                            </form>
                        </div>
                        
                        <div class="clearpicture4">
                            <form method="POST" action="{{ route('clearpicture4') }}"  enctype="multipart/form-data">
                            @csrf
                                <input type="hidden" name="imagedelete4" value="{{ $id }}">
                                <input type="hidden" name="image2delete" value="{{ $products->image4 }}">
                                <div><button type="submit" class="btn btn-primary waves-effect">Очистить картинку 4</button></div>
                            </form>
                        </div>
                        
                        <div class="clearpicture5">
                            <form method="POST" action="{{ route('clearpicture5') }}"  enctype="multipart/form-data">
                            @csrf
                                <input type="hidden" name="imagedelete5" value="{{ $id }}">
                                <input type="hidden" name="image2delete" value="{{ $products->image5 }}">
                                <div><button type="submit" class="btn btn-primary waves-effect">Очистить картинку 5</button></div>
                            </form>
                        </div>
                        
                        <div class="clearpicture6">
                            <form method="POST" action="{{ route('clearpicture6') }}"  enctype="multipart/form-data">
                            @csrf
                                <input type="hidden" name="imagedelete6" value="{{ $id }}">
                                <input type="hidden" name="image2delete" value="{{ $products->image6 }}">
                                <div><button type="submit" class="btn btn-primary waves-effect">Очистить картинку 6</button></div>
                            </form>
                        </div>
                        <div class="clearpicture7">
                            <form method="POST" action="{{ route('clearpicture7') }}"  enctype="multipart/form-data">
                            @csrf
                                <input type="hidden" name="imagedelete7" value="{{ $id }}">
                                <input type="hidden" name="image2delete" value="{{ $products->file }}">
                                <div><button type="submit" class="btn btn-primary waves-effect">Очистить драйвер</button></div>
                            </form>
                        </div>
                    </div>
                </div>
