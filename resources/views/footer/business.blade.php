...
@section('title', $seo[6]->title ?? $seo[6]->Name)
@section('description', $seo[6]->description ?? $seo[6]->Name)
@section('keywords', $seo[6]->keywords ?? $seo[6]->Name)
@section('content')
<div class="inner-content-block">
    <div class="inner-content">
        <div class="inner">
            <div class="inner-zag"><h1>{{$otherpage[2]->name}}</h1></div>
            <div class="services-inner-otherpage" style="margin-top: 0;">
                    {!!$otherpage[2]->description!!}
            </div>
        </div>
    </div>
</div>
