                            ...
                            <form method="POST" action="{{ route('user.store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10"><input id="innbin" type="innbin" class="form-control{{ $errors->has('innbin') ? ' is-invalid' : '' }}"
                                        name="innbin" value="{{ old('innbin') }}" required placeholder="Введите ИИН/БИН компании" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                        type = "number"
                                        maxlength = "12"></div>
                                </div>
                                
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label" for="innbin">Роли</label>
                                    <div class="col-sm-10">
